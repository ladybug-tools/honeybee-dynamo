...
class SunlightHoursAnalysisRecipe(HBSunlightHoursAnalysisRecipe):
    ...
    def __init__(self, sunVectors, pointGroupsT, vectorGroupsT=None, timestep=1):
        """Create sunlighthours recipe."""
        # convert DataTrees to lists
        if not vectorGroupsT:
            vectorGroupsT = []
    ...
    @classmethod
    def fromLBSuns(cls, suns, pointGroups, vectorGroups=None, timestep=1,
